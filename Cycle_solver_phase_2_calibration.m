...
GE_inletflow_cs = GE_data(109, :);              %GE inlet mass flow rate [pps]
GE_inletflow = GE_inletflow_cs * 0.453592;      %GE inlet mass flow [kg / s]
...
MassFlowProducts(22) = zeros;        %products mass flow rate output [kg / s]
MassFlowFuel(22) = zeros;            %output fuel mass flwo rate [kg / s]
Least_squares = zeros(7, 7, 7, 7)    %search space
...
for lpc_eff = lower_bound:step:upper_bound
    
    for hpc_eff = lower_bound:step:upper_bound
